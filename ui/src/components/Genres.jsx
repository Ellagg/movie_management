...
const CreateGenre = () => {
  ...
  return (
    <div className="page-container">
      ...
      <div className="create-movie-container">
        <h2>Update Genre</h2>
        <select value={genreToUpdate} onChange={e => {
        ...
        <input type="text" placeholder="New Genre Name" value={updatedName} onChange={e => setUpdatedName(e.target.value)} />
      ...
      <div className="create-movie-container">
        <h2>Delete Genre</h2>
        <select value={genreToDelete} onChange={e => setGenreToDelete(e.target.value)}>
          <option value="">--Select Genre--</option>
          {genres.map(g => (
            <option key={g.genreID} value={g.genreID}>{g.genreName}</option>
          ))}
